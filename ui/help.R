tabPanel("Help",
         sidebarLayout(
           ...
           mainPanel(
           h4(a(em(strong('Ramirez-Hassan, A. & Graciano-Londono, M. (2019). "A GUIded tour of Bayesian regression"',style = 'color:light blue')),href = "http://www.besmarter-team.org/files/working_papers/A%20GUIded%20tour%20around%20Bayesian%20regression.pdf")
           ),
